...
class Board_qaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_board_qa)
        ...
        var cursor: Cursor
        cursor = sqlDB.rawQuery("SELECT * FROM table_board_QA;", null)
        ...
        while(cursor.moveToNext()){
            ...
            layout_item.setOnClickListener{
                ...
                intent.putExtra("intent_table_name","table_board_QA")
