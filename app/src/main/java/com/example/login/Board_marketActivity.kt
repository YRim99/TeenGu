...
class Board_marketActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_board_market)
        ...
        var cursor: Cursor
        cursor = sqlDB.rawQuery("SELECT * FROM table_board_market;", null)
        ...
        while(cursor.moveToNext()){
            ...
            layout_item.setOnClickListener{
                ...
                intent.putExtra("intent_table_name","table_board_market")
